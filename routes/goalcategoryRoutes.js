...
const goalcategoryController = require('../controllers/goalcategoryController');
const auth = require('../utils/auth');

// create a router
const goalcategoryRouter = express.Router();

goalcategoryRouter.get('/',auth.isAuthenticated, goalcategoryController.getGoalCategories);
...
// export the router
module.exports = goalcategoryRouter;