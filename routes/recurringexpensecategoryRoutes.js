...
const recurringexpensecategoryController = require('../controllers/recurringexpensecategoryController');
const auth = require('../utils/auth');

// create a router
const recurringexpensecategoryRouter = express.Router();

recurringexpensecategoryRouter.get('/',auth.isAuthenticated, recurringexpensecategoryController.getRecurringExpenseCategories);
...
// export the router
module.exports = recurringexpensecategoryRouter;